...
class BarangsController extends Controller
{
    ...
    {
        $data = Barang::get();
        return view('staf.barang', compact('data'));
    }

    public function tambahbarang()
    {
        return view('staf.barang.tambahb');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staf.barang')->with('success', 'Data berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        $data = Barang::find($id);
        if (!$data) {
            return redirect()->route('staf.barang')->withErrors('Data tidak ditemukan.');
        }
        return view('staf.barang.editb', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('staf.barang')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('staf.barang')->with('success', 'Data berhasil dihapus.');
    }
}
