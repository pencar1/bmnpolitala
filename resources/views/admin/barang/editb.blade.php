...
<div class="page-inner">
    <div class="page-header">
        <div class="col-md-12">
            <form action="{{ route('barang.update', ['id' => $data->idbarang]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    ...
                    <div class="card-action">
                        ...
                        <button type="button" class="btn btn-danger" onclick="window.location.href='{{ route('barang') }}'">Batal</button>
                    </div>
                </div>
            </form>
        </div>
