...
<div class="page-inner">
    <div class="page-header">
        <div class="col-md-12">
            <form action="{{ route('staf.barang.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsibarang" value="{{ old('deskripsibarang') }}"  class="form-control" id="deskripsibarang" placeholder="Masukkan Deskripsi" rows="5"></textarea>
                    ...
                    <div class="card-action">
                        ...
                        <button type="button" class="btn btn-danger" onclick="window.location.href='{{ route('staf.barang') }}'">Batal</button>
                    </div>
                </div>
            </form>
        </div>
