                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('staf.transportasi.tambah') }}" class="btn btn-primary btn-round ml-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="{{ route('staf.transportasi.edit', ['id' => $d->idtransportasi]) }}" data-toggle="tooltip" title="Ubah Transportasi" class="btn btn-link btn-primary btn-lg">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form action="{{ route('staf.transportasi.destroy', ['id' => $d->idtransportasi]) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
