...
<div class="page-inner">
    <div class="page-header">
        <div class="col-md-12">
            <form action="{{ route('staf.arsiptolak.detail', ['id' => $peminjaman->idpeminjaman]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-action">
                            <button type="button" class="btn btn-success" onclick="window.location.href='{{ route('staf.arsiptolak') }}'">Kembali</button>
                        </div>
                    </div>
                </div>
            </form>
